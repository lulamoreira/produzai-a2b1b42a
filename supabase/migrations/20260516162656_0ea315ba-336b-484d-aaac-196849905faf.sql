...
GRANT EXECUTE ON FUNCTION public.get_adjustment_requote(text) TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.mark_requote_filling(text) TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.submit_adjustment_requote(text, jsonb, jsonb, text) TO anon, authenticated;