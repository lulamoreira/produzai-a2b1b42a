...
export const supplierPortalLabels = {
  "pt-BR": {
    ...
    storesButton: "Ver Lojas",
    storesTitle: "Lojas da Campanha",
    storesSummaryInstall: "com Frete + Instalação",
    storesSummaryFreteOnly: "Frete Apenas",
    storesSummaryNoLogistics: "Sem Logística",
    storesColName: "Nome",
    storesColAlias: "Apelido",
    storesColCity: "Cidade",
    storesColAddress: "Endereço",
    storesColType: "Tipo de Entrega",
    storesDownload: "⬇ Baixar Planilha",
  },
  "es-CL": {
    loading: "Cargando...",
