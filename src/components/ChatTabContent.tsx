  ...
  return (
    <div className="border border-border rounded-xl bg-card overflow-hidden h-full" style={{ minHeight: 400 }}>
      <div className="flex h-full">
        {/* Conversation List */}
        <aside
          className={`w-full md:w-72 border-r border-border flex flex-col ${
          ...
          {selectedConversation ? (
                      ...
                      >
                        {editingMessage?.id === msg.id ? (
                          <div className="flex items-center gap-1">
                            ...
                            <button onClick={() => setEditingMessage(null)} className="p-0.5 rounded hover:bg-primary-foreground/20">
            ...
            <div className="flex-1 flex items-center justify-center text-center">
              <div>
                ...
                <p className="text-muted-foreground text-sm">Selecione uma conversa ou inicie uma nova</p>
              </div>
            </div>
          )}
        </main>
