...
import { Download, FileSpreadsheet, FileText, ArrowUpDown } from "lucide-react";
...
export default function PendingOccurrencesDashboard({ open, onOpenChange, campaignId, campaignName, clientName, agencyName, stores, motives, statuses }: Props) {
          ...
          <Table>
            ...
            <TableBody>
              ...
              {sortedPending.map((occ) => {
                ...
                return (
                  <TableRow key={occ.id} className={isOverdue ? "bg-red-50 dark:bg-red-950/20" : ""}>
