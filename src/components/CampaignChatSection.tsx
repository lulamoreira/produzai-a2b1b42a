...
const CampaignChatSection = ({ campaignId }: CampaignChatSectionProps) => {
  const { user } = useAuth();
  ...
  const { data: conversations = [], isLoading: loadingConvs } = useConversations(campaignId);
  ...
  return (
    <>
      <div className="border border-border rounded-xl bg-card overflow-hidden" style={{ height: "calc(100vh - 14rem)", minHeight: 400 }}>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-[10px] text-primary/70 font-medium truncate">{conv.subject || "Geral"}</p>
                        </div>
              ...
              <>
                ...
                <div className="px-4 py-3 border-b border-border flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <span className="text-[10px] text-primary/70">{selectedConv?.subject || "Geral"}</span>
                  </div>
                </div>
...
export default CampaignChatSection;
