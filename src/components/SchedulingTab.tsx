      ...
      <div className="flex items-center gap-2 flex-wrap">
        {contact.phone && (
          <span className="flex items-center gap-1">
            ...
            {contact.phone}
            <a
              href={buildWhatsAppUrl(contact.phone, contact.name, agencyName, clientName, campaignName, schedule?.scheduled_date ?? null, schedule?.scheduled_time ?? null, schedulingMsgTemplate)}
              target="_blank"
